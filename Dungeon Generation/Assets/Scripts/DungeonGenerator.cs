...
public class DungeonGenerator : MonoBehaviour
{
    ...
    void SplitRoom(RectInt room, bool splitHorizontally)
    {
        ...
        Debug.Log(room1Divider);
        Debug.Log(room2Divider);
    ...
    void GenerateRooms()
    {
        ...
        int amount = 0;
        while (horizontalSplittableRooms.Count > 0 && amount < 100)
        {
            amount++;
            SplitRoom(horizontalSplittableRooms[0], Random.Range(0, 1) == 1);
        }
        
        
        int amount2 = 0;
        while (verticalSplittableRooms.Count > 0 && amount2 < 100)
        {
            amount2++;
            SplitRoom(verticalSplittableRooms[0], Random.Range(0, 1) == 1);
        }
